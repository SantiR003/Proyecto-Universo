            ...
            <section className="container-universeData">
                ...
                <div className="buttons">
                    ...
                    <div className="btn-group">
                        ...
                        <ul className="dropdown-menu personalized-menu">
                            <li><a /* onClick={() => select('')} */ className="dropdown-item personalized-menu" href="#card-selected">¿Que son?</a></li>
                            <li><a /* onClick={() => select('')} */ className="dropdown-item personalized-menu" href="#card-selected">¿Que tipos hay?</a></li>
                        </ul>
                    </div>
                </div>
